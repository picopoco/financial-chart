...
#data = data >> select(X.Timestamp,X.Open,X.High,X.Low,X.Close,X.Volume__BTC_,X.Volume__Currency_,X.Weighted_Price)
data = data >> select(X.Close,X.Timestamp,X.Open,X.High,X.Low,X.Volume__Currency_)
#print("(X.Open)",data)
